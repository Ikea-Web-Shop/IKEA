...
<img src={images['Sustainability/sunlight.jpg']} alt="IKEA sustainability ambitions for 2030"  className="w-full" />

          
<div className=" mt-10 ">
<p className="font-bold mt-12  text-4xl ">The Sustainability Report FY21 is here</p>
<p className="font-normal mt-12  text-lg ">
...
<p className="font-normal mt-12  text-lg mb-10">
